...
class OrganizersRegister extends StatefulWidget {
  const OrganizersRegister({super.key});

  @override
  State<OrganizersRegister> createState() => _OrganizersRegisterState();
}

class _OrganizersRegisterState extends State<OrganizersRegister> {
